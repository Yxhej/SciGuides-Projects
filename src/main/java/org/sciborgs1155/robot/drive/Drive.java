...
public class Drive extends SubsystemBase implements Logged, AutoCloseable {
  ...
  public static Drive create() {
    if (Robot.isReal()) {
      return switch (TYPE) {
        case TALON -> new Drive(
            new NavXGyro(),
            new TalonModule(FRONT_LEFT_DRIVE, FRONT_LEFT_TURNING, ANGULAR_OFFSETS.get(0), "FL"),
            new TalonModule(FRONT_RIGHT_DRIVE, FRONT_RIGHT_TURNING, ANGULAR_OFFSETS.get(1), "FR"),
            new TalonModule(REAR_LEFT_DRIVE, REAR_LEFT_TURNING, ANGULAR_OFFSETS.get(2), "RL"),
            new TalonModule(REAR_RIGHT_DRIVE, REAR_RIGHT_TURNING, ANGULAR_OFFSETS.get(3), "RR"));
        case SPARK -> new Drive(
            new NavXGyro(),
